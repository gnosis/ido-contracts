...
const clearAuctionSimplified: () => void = () => {
    task("clearAuctionSimplified", "Provides the clearing price to an auction")
        ...
        .addParam("numberOfOrdersToClear", "The number of orders that need to be considered for clearing - in most of teh cases, this number does not need to be exact")
